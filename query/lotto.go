...
func DrawsChongqing() {
	// //draw
	if info, err := models.GetDrawno(time.Now(), 320); info != nil && err == nil {
		log.Println("New Draws 120 is Chongqing......", info.Drawno, info.Resultballs)
	} //fmt.Println

}

//获取流媒体
func GetRequested(urls, referer string) ([]byte, error) {
	x := 1
LABEL1:
	strUrl := urls
